...
class NosqlCRUDBase(Generic[CreateSchemaType, UpdateSchemaType]):
    def __init__(
        self,
    ...
    def delete(self, opt, physical: bool = False, is_many: bool = False):
        """
